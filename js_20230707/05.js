...
// 84 행에서 arr13 이 저장한 주소를 arr14 한테 할당(복사)하면
// 같은 주소를 저장하게 됨
...
// 깊은 복사 (deep copy) : 1 + 2 차원 단계에서의 복사 (1차원 것도 복사, 2차원 것도 복사)
const arr18 = [
    [1, 2, 3],
    [4, 5, 6],
    [7, 8, 9]
...
console.log('arr20[1][1] : ', arr20[1][2]);
